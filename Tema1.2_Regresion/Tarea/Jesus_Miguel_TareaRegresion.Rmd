...
Podría aplicar el método de stepwise en su versión `forward` partiendo del modelo actual, tratando de buscar si se percibe alguna mejora añadiendo variables transformadas.

```{r depurar_modelo}
ajuste_0 <- mejor_modelo
...
formula <- as.formula(paste("Price ~", paste(columnas_modelo, collapse = "+"), "+",
